...
.cta:hover { background: #1a1a1a; border-color: #3f3f46; }
...
.content .desc {
  ...
  max-width: 680px;
      ...
      <header className="header">
        <a className="brand" href="https://github.com/walid-idrissi-labs" target="_blank" rel="noopener noreferrer">
              Walid-Idrissi-Labs
        </a>
        <a
          className="cta"
        ...
        >
            Check Out GitHub Repository to Learn More
            <Github className="inline" size={18} style={{ marginLeft: '8px',  paddingBottom:'3px'}} />
        </a>
      </header>
      ...
      <main className="hero">
        <div>
          <div className="kicker">Powered By Cloud</div>
            <h1 className="title"> Generate ShortURLs
            <br/>
                  <ShinyText
                  text="Instantly."
                  speed={2}
          ...
          <p className="subtitle">Generate short URLs instantly, powered by infrastructure deployed on AWS.</p>
        </div>
      </main>

      {/* Bottom content */}
      <section className="content">
        <div className="tag">Infrastructure as Code + AWS</div>
        <div className="heading">Serverless. Seamless. Instant.</div>
        <p className="desc">
          Created as a hands-on cloud engineering project, fully provisioned with Terraform and running on AWS.
        </p>
      </section>
    </section>
  );
